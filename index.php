...
<body>
    ...
    <div class="ms-all-content ms-content-mobile-space pt-130">
        <main>
            ...
            <section class="ms-banner-area p-relative">
                ...
                <div class="container-fluid ms-maw-1710">
                    <div class="ms-br-30 mx-auto include__bg z-index-1 ms-overlay-1 p-relative"
                        data-background="assets/img/banner/banner-bg.webp">
                        <div class="container">
                                    ...
                                    <div class="ms-banner__main-wrapper">
                                        <div class="ms-banner__content text-center">
                                            <h1 class="ms-banner__bg-title"
                                                data-background="assets/img/banner/title-bg.webp">
                                                THE NOBLES
                                            </h1>
                                            <h2 class="ms-banner__title msg_title bd-title-anim">An Exceptional Live
                                                Band Of
                                                Professional Musicians For Your
                                                Club, Event, Party Or Wedding.</h2>
                                        </div>
            ...
            <!-- work area start -->
            <section class="work__area work-overlay pt-125 pb-60 include__bg" data-background="assets/img/bg/bg.webp ">
                <img class="work__vactor-shape d-none d-xl-block" src="assets/img/work/vactoe-shape.png"
                    alt="vactoe-shape.png">
                <div class="container">
                    <div class="section__title-wrapper text-center mb-50 bd-title-anim">
                        <h2 class="section__title two">

                            <span class="animated-underline active">Band Members</span>
                        </h2>
                    </div>
                    <div class="row align-items-center justify-content-center bdFadeUp">
                        <div class="col-xl-2 lg-2">
                        </div>
                        <div class="col-xl-5 lg-5">
                            <div class="work__thumb ">
                                <img src="assets/img/work/singer-2.webp" alt="work image">
                            </div>
                        </div>
                        <div class="col-xl-3 lg-3 md-12 justify-content-center">
                    ...
                    <div class="row align-items-center justify-content-center bdFadeUp">
                        ...
                        <div class="col-xl-5 lg-5">
                            <div class="work__thumb ">
                                <img src="assets/img/work/singer-3.webp" alt="work image">
                            </div>
                        </div>
                        <div class="col-xl-3 lg-3 md-12 justify-content-center">
                            <div class="work__content-wrapper work__content-space mb-70 pl-40">
                    ...
                    <div class="row align-items-center justify-content-center bdFadeUp">
                        ...
                        <div class="col-xl-5 lg-5">
                            <div class="work__thumb ">
                                <img src="assets/img/work/singer-1.webp" alt="work image">
                            </div>
                        </div>
                        <div class="col-xl-3 lg-3 md-12 justify-content-center">
                            <div class="work__content-wrapper work__content-space mb-70 pl-40">
                                <div class="work__features-inner">
                                    <div class="work__features-item">
                                        <div class="work__features-content">
                                            <h4>Ritchie Patric</h4>
                                            <p>Drums | Digital Marketing
                                            </p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row align-items-end mb-25 bdFadeUp">
                        <div class="col-lg-8">
                            <div class="section__title-wrapper mb-40 bd-title-anim">
                                ...
                                <div id="msg-title">
                                    <h2 class="section__title"><span class="animated-underline active">Some Popular
                                            Venues</span>
                                    </h2>
                                </div>
                            </div>
                    ...
                    <div class="row bdFadeUp">
                        <div class="trending-grid">
                            <div class="trending-item">
                                <div class="trending__thumb" data-background="assets/img/trending/band-2.webp"></div>
                                <div class="trending__info">
                                    <div class="trending__number">
                                        <span>01</span>
                                    </div>
                                    <div class="trending__arrow">
                                        <a href="assets/img/trending/band-2.webp" class="popup-image"><i
                                                class="fa-regular fa-arrow-right-long"></i></a>
                                    </div>

                                    <span class="trending__title"><img src="assets/img/logo/logo.png " width="100px"
                                            alt=""></span>
                            ...
                            <div class="trending-item">
                                <div class="trending__thumb" data-background="assets/img/trending/band-1.webp"></div>
                                <div class="trending__info">
                                    <div class="trending__number">
                                        <span>02</span>
                                    </div>
                                    <div class="trending__arrow">
                                        <a href="assets/img/trending/band-1.webp" class="popup-image"><i
                                                class="fa-regular fa-arrow-right-long"></i></a>
                                    </div>
                            ...
                            <div class="trending-item">
                                <div class="trending__thumb" data-background="assets/img/trending/band-3.webp"></div>
                                <div class="trending__info">
                                    <div class="trending__number">
                                        <span>03</span>
                                    </div>
                                    <div class="trending__arrow">
                                        <a href="assets/img/trending/band-3.webp" class="popup-image"><i
                                                class="fa-regular fa-arrow-right-long"></i></a>
                                    </div>
                            ...
                            <div class="trending-item">
                                <div class="trending__thumb" data-background="assets/img/trending/band-4.webp"></div>
                                <div class="trending__info">
                                    <div class="trending__number">
                                        <span>04</span>
                                    </div>
                                    <div class="trending__arrow">
                                        <a href="assets/img/trending/band-4.webp" class="popup-image"><i
                                                class="fa-regular fa-arrow-right-long"></i></a>
                                    </div>
                            ...
                            <div class="trending-item">
                                <div class="trending__thumb" data-background="assets/img/trending/band-5.webp"></div>
                                <div class="trending__info">
                                    <div class="trending__number">
                                        <span>05</span>
                                    </div>
                                    <div class="trending__arrow">
                                        <a href="assets/img/trending/band-5.webp" class="popup-image"><i
                                                class="fa-regular fa-arrow-right-long"></i></a>
                                    </div>
                            ...
                            <div class="trending-item">
                                <div class="trending__thumb" data-background="assets/img/trending/band-6.webp"></div>
                                <div class="trending__info">
                                    <div class="trending__number">
                                        <span>06</span>
                                    </div>
                                    <div class="trending__arrow">
                                        <a href="assets/img/trending/band-6.webp" class="popup-image"><i
                                                class="fa-regular fa-arrow-right-long"></i></a>
                                    </div>
            ...
            <section class="ms-tm-area">
                <div class="container">
                    <div class="ms-tm-border pt-50 pb-50 mb-40">
                            ...
                            <div class="col-xl-5">
                                <div class="ms-tm-img-wrap ms-tm-space p-relative mb-60">
                                    <div class="ms-tm-img-main p-relative m-img">
                                        ...
                                        <img src="assets/img/testimonial/testi-img.png" alt="testimonial image">
                                    </div>
                            ...
                            <div class="col-xl-7">
                                <div class="ms-tm-content-wrap ms-tm-content-space mb-60">
                                    ...
                                    <div class="section__title-wrapper mb-30 bd-title-anim">
                                        <span class="section__subtitle">Client Feedback</span>
                                        <h2 class="section__title">
                                            Real Client Reviews
                                        </h2>
                                    </div>
                                            ...
                                            <div class="ms-tm-slick">
                                                <div class="ms-tm-slick-item">
                                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Magni,
                                                        harum cumque. Enim quaerat voluptates iure tenetur praesentium
                                                        temporibus, sunt ducimus!</p>
                                            ...
                                            <div class="ms-tm-slick">
                                                <div class="ms-tm-slick-item">
                                                    <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Ullam
                                                        harum sapiente, doloribus voluptatem eum quod sunt voluptate
                                                        voluptatibus quisquam nisi.</p>
                                                    <div class="ms-tm-author">
                                                        <h4 class="ms-tm-author-title">David Camerun</h4>
                                                        <span class="ms-tm-author-subtitle">Media Public
                                                            Manager</span>
                                            ...
                                            <div class="ms-tm-slick">
                                                <div class="ms-tm-slick-item">
                                                    <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ab
                                                        expedita saepe ea eligendi obcaecati necessitatibus consectetur
                                                        molestiae reprehenderit laboriosam ducimus?</p>
                                                    <div class="ms-tm-author">
                                                        <h4 class="ms-tm-author-title">David Camerun</h4>
                                                        <span class="ms-tm-author-subtitle">Media Public
                                                            Manager</span>
